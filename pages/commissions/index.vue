			...
			<view class="tui-order-item" v-for="(model,orderIndex) in 3" :key="orderIndex">
				<tui-list-cell :hover="false" :lineLeft="false">
					<view class="tui-goods-title">
						...
						<view class="tui-order-status">已返佣</view>
					</view>
				</tui-list-cell>
					...
					<tui-list-cell padding="0" >
						<view class="tui-goods-item">
							...
							<view class="tui-price-right">
								<view>￥298.00</view>
								<view style='color: rgb(228, 31, 25);'>￥12.00</view>
								<view>x2</view>
							</view>
						</view>
					</tui-list-cell>
				...
				<tui-list-cell :hover="false" :last="true">
					<view class="tui-goods-price">
						<view>共4件商品 合计：</view>
						<view class="tui-size-24" style='color: rgb(228, 31, 25);'>￥</view>
						<view class="tui-price-large" style='color: rgb(228, 31, 25);'>48</view>
						<view class="tui-size-24" style='color: rgb(228, 31, 25);'>.00</view>
					</view>
				</tui-list-cell>
			</view>
