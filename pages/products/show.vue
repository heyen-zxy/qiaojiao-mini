<template>
	<view class="container">
		...
		<view class="tui-operation">
			...
			<view class="tui-operation-right tui-right-flex tui-col-6 tui-btnbox-4">
				<view class="tui-flex-1">
					<tui-button type="danger" shape="circle" size="mini" @click="submit">立即购买</tui-button>
				</view>
			</view>
		</view>
