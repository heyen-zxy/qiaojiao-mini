				...
				<tui-swipe-action :actions="actions" @click="handlerButton" :params="item">
					<template v-slot:content>
						<view class="tui-goods-item">
							...
							<image :src="'/static/images/mall/product/detail/'+(index%2==0?'1.jpg':'4.jpg')" class="tui-goods-img" />
							<view class="tui-goods-info">
								<view class="tui-goods-title">
									{{index%2==0?"王力防盗门甲级门安全门大门霸王锁芯进户门入户门子母门/单门GL208选配指纹锁门 950*2050标尺":"客厅灯 led吸顶灯卧室灯现代简约餐厅儿童房书房灯具套餐套装全屋灯饰 流星款 圆形40CM 三色变光（48W）"}}
								</view>
								<view class="tui-goods-model">
									<view class="tui-model-text">{{index%2==0?"1.2米;数量：2":"1.3米;数量：1"}}</view>
